/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="/js/commentWidget.js"></script>
...
const s_textId = '566465508';
const s_pageId = '232452366';
const s_replyId = '1310201019';
const s_sheetId = '15j-R7fExRqynZMZ8_zf_y_ZIfNKRBwOcgXsv8lKWyf4';
...
const s_maxLength = 200; // The max character length of a comment
...
const v_formHtml = `
    ...
    <div id="c_websiteWrapper" class="c-inputWrapper">
        ...
        <input class="c-input c-websiteInput" name="entry.${s_websiteId}" id="entry.${s_websiteId}" type="url" pattern="https://.*" placeholder="website link (optional)">
    </div>
